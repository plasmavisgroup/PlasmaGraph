...
public class TemplateTests {
    ...
    public void testSaveAndOpenTemplate () {
        ...
        t1.setInterpolationType (InterpolationType.POWER);
        ...
        assertEquals ("Interpolation Type Changed? ", t2.getInterpolationType (), InterpolationType.POWER);
        assertEquals ("Outlier Response Changed? ", t2.getOutlierResponse (), OutlierResponse.REMOVE);
    }
