...
{
    java.lang.String _PROJECTS_PATH = "C:\\Users\\Administrator\\Desktop\\JMatIO-041212\\"; 
...
//        assertEquals("Test if value red from file equals value stored", mlDouble, mlArrayRetrived);
    ...
    {
        //array name
        File file = new File(_PROJECTS_PATH + "test/cell.mat");
    ...
    public void testDoubleFromMatlabCreatedFile() throws Exception
    {
        ...
        String fileName = _PROJECTS_PATH + "test/matnativedouble.mat";
    ...
    public void testDoubleFromMatlabCreatedFile2() throws IOException
    {
        ...
        String name = "arr";
        //file name in which array will be stored
        String fileName = _PROJECTS_PATH + "test/matnativedouble2.mat";
    ...
    {
        //array name
        File file = new File(_PROJECTS_PATH + "test/sparse.mat");
        MatFileReader reader = new MatFileReader( file );
    ...
    {
        //array name
        File file = new File(_PROJECTS_PATH + "test/simplestruct.mat");
        MatFileReader reader = new MatFileReader( file );
    ...
    {
        final String fileName = _PROJECTS_PATH + "test/nan.mat";
    ...
    {
        String fileName = _PROJECTS_PATH + "test/uint8.mat";
        String arrName = "arr";
        MatFileReader mfr;
        MLArray src;
    ...
    {
        String fileName = _PROJECTS_PATH + "test/int8.mat";
        String arrName = "arr";
        MatFileReader mfr;
        MLArray src;
    ...
    {
        String fileName = _PROJECTS_PATH + "test/int64.mat";
        String arrName = "arr";
        MatFileReader mfr;
        MLArray src;
    ...
    {
        String fileName = _PROJECTS_PATH + "test/uint64.mat";
        String arrName = "arr";
        MatFileReader mfr;
        MLArray src;
    ...
    public void testBigSparseFile() throws IOException
    {
        ...
        mfr.read( new File(_PROJECTS_PATH + "test/bigsparse.mat"), MatFileReader.DIRECT_BYTE_BUFFER );
    ...
    public void testSingle() throws Exception
    {
        ...
        MLSingle readSingleMatlabGenerated = (MLSingle) reader.read( new File(_PROJECTS_PATH + "test/single.mat") ).get( "arr" );
    ...
    {
        MatFileReader mfr = new MatFileReader();
        Map<String, MLArray> content = mfr.read( new File(_PROJECTS_PATH + "test/java.mat") );
    ...
    {
        MatFileReader mfr = new MatFileReader();
        Map<String, MLArray> content = mfr.read( new File(_PROJECTS_PATH + "test/object.mat") );
...
//        System.out.println(mlObject.getObject().getFieldNames());
    ...
    public void testInt32() throws IOException
    {
        ...
        String name = "a";
        //file name in which array will be stored
        String fileName = _PROJECTS_PATH + "test/int32.mat";
