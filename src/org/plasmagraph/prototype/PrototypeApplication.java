 ...
 * @author tako
 */
public class PrototypeApplication extends javax.swing.JFrame {

    public Template current_template;
    public File current_data;
    /** Creates new form PrototypeApplication */
    ...
    private void initComponents() {
        ...
        PrototypeOptionsLabel.setFont(new java.awt.Font("Dialog", 0, 36)); // NOI18N
...
private void PrototypeGenerateChartButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PrototypeGenerateChartButtonActionPerformed
    ...
    // Prompt for auto-save of Template.
    
    // Prompt for auto-save of Chart.
...
private void PrototypeExitMenuOptionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PrototypeExitMenuOptionActionPerformed
    ...
    int response = JOptionPane.showConfirmDialog
            (this, "Do you wish to close PlasmaGraph?", "Exiting PlasmaGraph.", JOptionPane.QUESTION_MESSAGE);
...
// @TODO: Create try / catch block around this.
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrototypeApplication.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new PrototypeApplication().setVisible(true);
            }
        });
    }
